...
/**
 * <p>
 * Responsible for creating the instances of <code>{@link JobRunShellTsp}</code>
 * to be used within the <class>{@link QuartzScheduler}</code> instance.
 * </p>
 * 
 * @author James House
 */
public interface JobRunShellFactoryTsp {
     ...
     * to obtain instances of <code>{@link JobRunShellTsp}</code>.
     * </p>
     */
    JobRunShellTsp createJobRunShell(TriggerFiredBundle bundle) throws SchedulerException;
}